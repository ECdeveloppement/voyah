...
import { _ as _sfc_main$d } from "./LegacyDisclosurePage-RAl89wFh.js";
import { E as EnergyCenterPage } from "./EnergyCenterPage-BqyLajo3.js";
import { _ as _sfc_main$c } from "./ServiceCenterPage-Bp9r93bc.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.section.kind === "banner") {
        ...
        if (__props.section.kind === "carousel") {
          ...
          _push(`<!--]--></div><p class="model-carousel-drawer-text" data-v-fb3c63e7>${ssrInterpolate(unref(carouselSlides)[unref(activeSlide)]?.summary)}</p></div></div>`);
        } else {
          ...
          if (__props.section.videos?.length) {
            _push(`<video${ssrRenderAttr("poster", __props.section.image ?? __props.section.images[0] ?? "")} autoplay muted loop playsinline preload="metadata" data-v-fb3c63e7><source${ssrRenderAttr("src", __props.section.videos[0])} type="video/mp4" data-v-fb3c63e7></video>`);
          } else {
            _push(`<img${ssrRenderAttr("src", __props.section.image ?? __props.section.images[0] ?? "")}${ssrRenderAttr("alt", __props.section.title)} draggable="false" data-v-fb3c63e7>`);
          }
...
//# sourceMappingURL=_slug_-DH6RCZDC.js.map
