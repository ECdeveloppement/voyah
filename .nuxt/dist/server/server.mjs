import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, ref, resolveComponent, computed, unref, Fragment, createVNode, Text, defineAsyncComponent, Suspense, nextTick, mergeProps, withCtx, useSSRContext, createTextVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "E:/voyah-nuxt/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "E:/voyah-nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "E:/voyah-nuxt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestProtocol } from "E:/voyah-nuxt/node_modules/h3/dist/index.mjs";
...
import { defu } from "E:/voyah-nuxt/node_modules/defu/dist/defu.mjs";
import { klona } from "E:/voyah-nuxt/node_modules/klona/dist/index.mjs";
import { parse as parse$1 } from "E:/voyah-nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "E:/voyah-nuxt/node_modules/destr/dist/index.mjs";
import { isEqual as isEqual$1 } from "E:/voyah-nuxt/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CkaEyWO9.js")
  },
  {
    name: "store",
    path: "/store",
    component: () => import("./_nuxt/store-Bl1ZIo83.js")
  },
  {
    name: "energy",
    path: "/energy",
    component: () => import("./_nuxt/energy-ZZOof-zh.js")
  },
  {
    name: "service",
    path: "/service",
    component: () => import("./_nuxt/service-Dbv66l_s.js")
  },
  {
    name: "document",
    path: "/document",
    component: () => import("./_nuxt/document-BmQHFEJW.js")
  },
  {
    name: "purchasing",
    path: "/purchasing",
    component: () => import("./_nuxt/purchasing-iXveVnk9.js")
  },
  {
    name: "environmental",
    path: "/environmental",
    component: () => import("./_nuxt/environmental-DR7A-MAH.js")
  },
  {
    name: "locale",
    path: "/:locale()",
    component: () => import("./_nuxt/index-CUDbFzxW.js")
  },
  {
    name: "locale-slug",
    path: "/:locale()/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_slug_-GAhDqcE9.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-gCtOu30j.js").then((m) => m.default || m))
};
