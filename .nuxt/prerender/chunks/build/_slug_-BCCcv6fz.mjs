import { defineComponent, computed, unref, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, ref, watch, createSlots, useSSRContext } from 'file://E:/voyah-nuxt/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderSlot } from 'file://E:/voyah-nuxt/node_modules/vue/server-renderer/index.mjs';
import { u as useSectionReveal, _ as _sfc_main$1$1, a as _sfc_main$7 } from './MetricGrid-rQeQhs47.mjs';
import { u as useSiteContent, a as useSeoMeta } from './useSiteContent-DsUNBFs_.mjs';
  ...
  setup(__props) {
    ...
    const defaultTheme = {
      ...
      panelBody: copy(
        ...
        "L image, l information et les points de service restent alignes dans un meme rythme premium apais\xE9.",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(displayMetrics).length) {
        ...
        _push(ssrRenderComponent(_sfc_main$7, { metrics: unref(displayMetrics) }, null, _parent));
        _push(`</div></section>`);
      } else {
        _push(`<!---->`);
      }
      ...
      ssrRenderList(__props.page.blocks, (block, index) => {
        var _a;
        _push(`<div${ssrRenderAttr("id", (_a = unref(sectionLinks)[index]) == null ? void 0 : _a.id)} class="${ssrRenderClass(["info-feature", { reverse: index % 2 === 1 }])}" data-v-815849c8><div class="container info-feature__grid" data-v-815849c8><div class="info-feature__media" data-reveal data-v-815849c8><div class="info-feature__media-shell" data-v-815849c8><img${ssrRenderAttr("src", block.image)}${ssrRenderAttr("alt", unref(textFor)(block.title))} data-v-815849c8><div class="info-feature__badge" data-v-815849c8>${ssrInterpolate(chapterLabel(index))}</div></div></div><article class="info-feature__copy" data-reveal data-v-815849c8><p class="info-feature__kicker" data-v-815849c8>${ssrInterpolate(chapterLabel(index))}</p><h2 class="info-feature__title" data-v-815849c8>${ssrInterpolate(unref(textFor)(block.title))}</h2><p class="info-feature__body" data-v-815849c8>${ssrInterpolate(unref(textFor)(block.body))}</p></article></div></div>`);
      });
      _push(`<!--]--></section>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
      ...
      return [
        {
          ...
          title: textFor((_b = (_a = props.model.features[0]) == null ? void 0 : _a.title) != null ? _b : props.model.title),
          summary: textFor((_d = (_c = props.model.features[0]) == null ? void 0 : _c.body) != null ? _d : props.model.description)
        },
        {
          kicker: modelLabel("Chapter 02", "Chapitre 02", "\u0627\u0644\u0641\u0635\u0644 02"),
          title: textFor((_f = (_e = props.model.features[1]) == null ? void 0 : _e.title) != null ? _f : props.model.title),
          summary: textFor((_h = (_g = props.model.features[1]) == null ? void 0 : _g.body) != null ? _h : props.model.subtitle)
        },
        {
          kicker: modelLabel("Chapter 03", "Chapitre 03", "\u0627\u0644\u0641\u0635\u0644 03"),
          title: textFor((_j = (_i = props.model.features[2]) == null ? void 0 : _i.title) != null ? _j : props.model.title),
          summary: textFor((_l = (_k = props.model.features[2]) == null ? void 0 : _k.body) != null ? _l : props.model.description)
        },
        {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><section id="book-drive" class="model-cta" style="${ssrRenderStyle({ "--cta-image": `url(${(_a = unref(gallery).at(-1)) != null ? _a : __props.model.heroImage})` })}" data-v-10b137d7><div class="container model-cta-card" data-reveal data-v-10b137d7><p class="model-cta-kicker" data-v-10b137d7>${ssrInterpolate(modelLabel("More from Voyah", "Plus de Voyah", "\u0627\u0644\u0645\u0632\u064A\u062F \u0645\u0646 Voyah"))}</p><h2 data-v-10b137d7>${ssrInterpolate(unref(textFor)(__props.model.title))}</h2><p data-v-10b137d7>${ssrInterpolate(unref(textFor)(__props.model.description))}</p><div class="button-row" data-v-10b137d7>`);
      _push(ssrRenderComponent(_sfc_main$1$1, {
        to: unref(buildPath)("book-drive.html"),
        variant: "primary"
      }, {
...
//# sourceMappingURL=_slug_-BCCcv6fz.mjs.map
