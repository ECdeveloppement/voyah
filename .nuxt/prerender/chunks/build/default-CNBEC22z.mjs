import { defineComponent, computed, mergeProps, unref, ref, watch, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file://E:/voyah/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderStyle } from 'file://E:/voyah/node_modules/vue/server-renderer/index.mjs';
import { u as useSiteContent, c as currentLocaleInfo, a as useHead } from './useSiteContent-DsX9M3mb.mjs';
import { _ as _export_sfc, u as useRoute, i as useNuxtApp, g as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="footer-records" data-v-fa175d47><span data-v-fa175d47>${ssrInterpolate(unref(recordLabel))}</span><span data-v-fa175d47>Copyright \xA9 ${ssrInterpolate(unref(currentYear))} Voyah.com.cn All rights reserved.</span></div></div></div></footer>`);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isHomeRoute.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(buildPath)((_b = (_a = currentModel.value) == null ? void 0 : _a.slug) != null ? _b : "titan.html"),
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(buildPath)((_d = (_c = currentModel.value) == null ? void 0 : _c.slug) != null ? _d : "titan.html"),
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(buildPath)((_f = (_e = currentModel.value) == null ? void 0 : _e.slug) != null ? _f : "titan.html"),
          class: "header-cta header-cta--primary"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      if (mobileOpen.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(buildPath)((_h = (_g = currentModel.value) == null ? void 0 : _g.slug) != null ? _h : "titan.html"),
          class: "header-cta header-cta--primary",
          onClick: ($event) => mobileOpen.value = false
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
...
//# sourceMappingURL=default-CNBEC22z.mjs.map
