...
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestProtocol, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file://E:/voyah-nuxt/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DDE-GDxG.mjs')
  },
  {
    name: "locale",
    path: "/:locale()",
    component: () => import('./index-bFbygOIz.mjs')
  },
  {
    name: "locale-slug",
    path: "/:locale()/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_slug_-D3VUy5sZ.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BeSZ5YdM.mjs').then((m) => m.default || m))
};
