...
import { $fetch } from 'file://E:/voyah/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file://E:/voyah/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://E:/voyah/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, getRequestProtocol, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file://E:/voyah/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION, isNavigationFailure } from 'file://E:/voyah/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://E:/voyah/node_modules/defu/dist/defu.mjs';
import { klona } from 'file://E:/voyah/node_modules/klona/dist/index.mjs';
import { parse as parse$1 } from 'file://E:/voyah/node_modules/cookie-es/dist/index.mjs';
import destr from 'file://E:/voyah/node_modules/destr/dist/index.mjs';
import { isEqual as isEqual$1 } from 'file://E:/voyah/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file://E:/voyah/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://E:/voyah/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-pC9NdjMj.mjs')
  },
  {
    name: "store",
    path: "/store",
    component: () => import('./store-CUyHm2Oy.mjs')
  },
  {
    name: "energy",
    path: "/energy",
    component: () => import('./energy-DRQclQUJ.mjs')
  },
  {
    name: "service",
    path: "/service",
    component: () => import('./service-usBoxKAh.mjs')
  },
  {
    name: "document",
    path: "/document",
    component: () => import('./document-CvDS_vQ4.mjs')
  },
  {
    name: "purchasing",
    path: "/purchasing",
    component: () => import('./purchasing-CQ1pRheK.mjs')
  },
  {
    name: "environmental",
    path: "/environmental",
    component: () => import('./environmental-BUH9x307.mjs')
  },
  {
    name: "locale",
    path: "/:locale()",
    component: () => import('./index-CVf2Ttge.mjs')
  },
  {
    name: "locale-slug",
    path: "/:locale()/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_slug_-D7tIP3wC.mjs')
  }
];
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-k2B17TXB.mjs'
    /* webpackChunkName: "config_i18n_46config_46ts_77bb3196" */
  )
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CNBEC22z.mjs').then((m) => m.default || m))
};
...
export { _export_sfc as _, footerLegalLinks as a, footerColumns as b, navigation as c, findLocale as d, entry_default as default, localize as e, footerContact as f, __nuxt_component_0$1 as g, homePage as h, useNuxtApp as i, locales as l, navigateTo as n, resolvePage as r, tryUseNuxtApp as t, useRoute as u };
