...
import { c as currentLocaleInfo, b as useHead, u as useSiteContent } from './useSiteContent-DsUNBFs_.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const appEyebrow = computed(() => {
      if (locale.value.code === "fr") return "T\xE9l\xE9charger l\u2019app Voyah";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="footer-records" data-v-4432ada4><span data-v-4432ada4>${ssrInterpolate(unref(recordLabel))}</span><span data-v-4432ada4>Copyright \xA9 2021 Voyah.com.cn All rights reserved.</span></div></div></div></footer>`);
    };
  }
});
...
//# sourceMappingURL=default-DCKt7HR-.mjs.map
