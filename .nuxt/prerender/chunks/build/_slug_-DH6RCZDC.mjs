...
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderSlot, ssrRenderStyle } from 'file://E:/voyah-nuxt/node_modules/vue/server-renderer/index.mjs';
import { u as useSectionReveal, _ as _sfc_main$1$1, a as _sfc_main$c } from './MetricGrid-Dhnmdwt_.mjs';
...
import { _ as _sfc_main$b } from './LegacyDisclosurePage-RAl89wFh.mjs';
import { E as EnergyCenterPage } from './EnergyCenterPage-BqyLajo3.mjs';
import { _ as _sfc_main$a } from './ServiceCenterPage-Bp9r93bc.mjs';
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-699e7882><div class="page-hero-media" data-v-699e7882>`);
      if (__props.video) {
        _push(`<video${ssrRenderAttr("poster", __props.image)}${ssrRenderAttr("aria-label", __props.title)} autoplay muted loop playsinline preload="metadata" data-v-699e7882><source${ssrRenderAttr("src", __props.video)} type="video/mp4" data-v-699e7882></video>`);
      } else {
        _push(`<img${ssrRenderAttr("src", __props.image)}${ssrRenderAttr("alt", __props.title)} data-v-699e7882>`);
      }
      _push(`</div><div class="page-hero-overlay" data-v-699e7882></div><div class="page-hero-gradient" data-v-699e7882></div><div class="page-hero-content" data-v-699e7882><div class="container" data-v-699e7882><div class="page-hero-shell" data-v-699e7882><div class="page-hero-copy" data-v-699e7882>`);
      if (__props.logo) {
        _push(`<img${ssrRenderAttr("src", __props.logo)}${ssrRenderAttr("alt", __props.title)} class="page-logo" data-v-699e7882>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<p class="eyebrow" data-v-699e7882>${ssrInterpolate(__props.eyebrow)}</p><h1 class="page-title" data-v-699e7882>${ssrInterpolate(__props.title)}</h1><p class="page-summary" data-v-699e7882>${ssrInterpolate(__props.summary)}</p>`);
      if (_ctx.$slots.actions) {
        _push(`<div class="button-row page-hero-actions" data-v-699e7882>`);
      ...
      _push(`</div>`);
      if (_ctx.$slots.meta) {
        _push(`<aside class="page-hero-meta" data-v-699e7882>`);
...
const PageHero = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-699e7882"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(theme).showMetrics && unref(displayMetrics).length) {
        ...
        _push(ssrRenderComponent(_sfc_main$c, { metrics: unref(displayMetrics) }, null, _parent));
        _push(`</div></section>`);
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-fb3c63e7>`);
      if (__props.section.kind === "banner") {
        _push(`<div class="model-banner" style="${ssrRenderStyle(unref(bannerStyle))}" data-v-fb3c63e7><div class="model-banner-overlay" data-v-fb3c63e7></div><div class="container model-banner-inner" data-reveal data-v-fb3c63e7><h2 class="model-banner-title" data-v-fb3c63e7>${ssrInterpolate(__props.section.title)}</h2>`);
        if (__props.section.summary) {
          _push(`<p class="model-banner-subtitle" data-v-fb3c63e7>${ssrInterpolate(__props.section.summary)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      } else {
        _push(`<div class="container model-media-content" data-v-fb3c63e7><div class="model-media-head" data-reveal data-v-fb3c63e7>`);
        if (__props.section.kicker) {
          _push(`<p class="model-media-kicker" data-v-fb3c63e7>${ssrInterpolate(__props.section.kicker)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<h2 class="model-media-title" data-v-fb3c63e7>${ssrInterpolate(__props.section.title)}</h2>`);
        if (__props.section.summary) {
          _push(`<p class="model-media-summary" data-v-fb3c63e7>${ssrInterpolate(__props.section.summary)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (__props.section.kind === "carousel") {
          _push(`<div class="model-carousel-wrap" data-reveal data-v-fb3c63e7><div class="model-carousel-stage" data-v-fb3c63e7>`);
          if (unref(activeCarouselSlide)) {
            _push(`<article class="model-carousel-card active model-carousel-card--featured" data-v-fb3c63e7><div class="model-carousel-media" data-v-fb3c63e7>`);
            if (unref(activeCarouselSlide).video) {
              _push(`<video${ssrRenderAttr("poster", unref(activeCarouselSlide).image)} autoplay muted loop playsinline preload="metadata" data-v-fb3c63e7><source${ssrRenderAttr("src", unref(activeCarouselSlide).video)} type="video/mp4" data-v-fb3c63e7></video>`);
            } else {
              _push(`<img${ssrRenderAttr("src", unref(activeCarouselSlide).image)}${ssrRenderAttr("alt", unref(activeCarouselSlide).title)} draggable="false" data-v-fb3c63e7>`);
            }
            _push(`</div><div class="model-carousel-copy" data-v-fb3c63e7><p class="model-carousel-copy-title" data-v-fb3c63e7>${ssrInterpolate(unref(activeCarouselSlide).title)}</p><p class="model-carousel-copy-text" data-v-fb3c63e7>${ssrInterpolate(unref(activeCarouselSlide).summary)}</p></div></article>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="model-carousel-rail" data-v-fb3c63e7><!--[-->`);
          ssrRenderList(unref(carouselSlides), (slide, slideIndex) => {
            _push(`<button type="button" class="${ssrRenderClass(["model-carousel-card", "model-carousel-card--rail", { active: unref(activeSlide) === slideIndex }])}" data-v-fb3c63e7><div class="model-carousel-rail-media" data-v-fb3c63e7><img${ssrRenderAttr("src", slide.image)}${ssrRenderAttr("alt", slide.title)} draggable="false" data-v-fb3c63e7></div><div class="model-carousel-rail-copy" data-v-fb3c63e7><p class="model-carousel-rail-title" data-v-fb3c63e7>${ssrInterpolate(slide.title)}</p><p class="model-carousel-rail-text" data-v-fb3c63e7>${ssrInterpolate(slide.summary)}</p></div></button>`);
          });
          _push(`<!--]--></div></div><div class="model-carousel-pagination" aria-hidden="true" data-v-fb3c63e7><!--[-->`);
          ssrRenderList(unref(carouselSlides), (slide, slideIndex) => {
            _push(`<button type="button" class="${ssrRenderClass(["model-carousel-bullet", { active: unref(activeSlide) === slideIndex }])}" data-v-fb3c63e7></button>`);
          });
          _push(`<!--]--></div><div class="model-carousel-drawer" data-v-fb3c63e7><div class="model-carousel-list" data-v-fb3c63e7><!--[-->`);
          ssrRenderList(unref(carouselSlides), (slide, slideIndex) => {
            _push(`<button type="button" class="${ssrRenderClass(["model-carousel-item", { active: unref(activeSlide) === slideIndex }])}" data-v-fb3c63e7><p class="model-carousel-item-title" data-v-fb3c63e7>${ssrInterpolate(slide.title)}</p></button>`);
          });
          _push(`<!--]--></div><p class="model-carousel-drawer-text" data-v-fb3c63e7>${ssrInterpolate((_a = unref(carouselSlides)[unref(activeSlide)]) == null ? void 0 : _a.summary)}</p></div></div>`);
        } else {
          _push(`<div class="model-image-block" data-reveal data-v-fb3c63e7><div class="model-image-frame" data-v-fb3c63e7>`);
          if ((_b = __props.section.videos) == null ? void 0 : _b.length) {
            _push(`<video${ssrRenderAttr("poster", (_d = (_c = __props.section.image) != null ? _c : __props.section.images[0]) != null ? _d : "")} autoplay muted loop playsinline preload="metadata" data-v-fb3c63e7><source${ssrRenderAttr("src", __props.section.videos[0])} type="video/mp4" data-v-fb3c63e7></video>`);
          } else {
            _push(`<img${ssrRenderAttr("src", (_f = (_e = __props.section.image) != null ? _e : __props.section.images[0]) != null ? _f : "")}${ssrRenderAttr("alt", __props.section.title)} draggable="false" data-v-fb3c63e7>`);
          }
          _push(`</div><div class="model-detail-grid" data-v-fb3c63e7><!--[-->`);
          ssrRenderList(unref(details), (detail, detailIndex) => {
            _push(`<article class="model-detail-card" data-v-fb3c63e7><p class="model-detail-title" data-v-fb3c63e7>${ssrInterpolate(detail.title)}</p><p class="model-detail-summary" data-v-fb3c63e7>${ssrInterpolate(detail.summary)}</p></article>`);
          });
          _push(`<!--]--></div></div>`);
        }
        _push(`</div>`);
...
const ModelMediaSection = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fb3c63e7"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(PageHero, {
        ...
        meta: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<aside class="model-hero-meta" data-v-26d48174${_scopeId}><p class="model-hero-price" data-v-26d48174${_scopeId}>${ssrInterpolate(unref(textFor)(__props.model.price))}</p><div class="model-hero-features" data-v-26d48174${_scopeId}><!--[-->`);
            ssrRenderList(__props.model.features.slice(0, 3), (feature) => {
              _push2(`<span data-v-26d48174${_scopeId}>${ssrInterpolate(unref(textFor)(feature.title))}</span>`);
            });
            _push2(`<!--]--></div></aside>`);
          } else {
            return [
...
const ModelPage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-26d48174"]]);
...
//# sourceMappingURL=_slug_-DH6RCZDC.mjs.map
