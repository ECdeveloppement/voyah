"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.supportedSlugs = exports.sitePages = exports.resolvePage = exports.navigation = exports.localize = exports.locales = exports.homePage = exports.footerLegalLinks = exports.footerContact = exports.footerColumns = exports.findLocale = void 0;const locales = exports.locales = [
...
const sitePages = exports.sitePages = [...models, ...infoPages, ...legalPages];
const supportedSlugs = exports.supportedSlugs = sitePages.map((page) => page.slug);
const sitePageMap = new Map(sitePages.map((page) => [page.slug, page]));

const homePage = exports.homePage = {
  slides: [
  {
...
const footerColumns = exports.footerColumns = [
{
...
const footerLegalLinks = exports.footerLegalLinks = [
...
const footerContact = exports.footerContact = {
...
const localize = (text, locale) => text[locale] ?? text.en;exports.localize = localize;

const findLocale = (code) => locales.find((locale) => locale.code === code);exports.findLocale = findLocale;

const resolvePage = (slug) => slug ? sitePageMap.get(slug) : undefined;exports.resolvePage = resolvePage; /* v9-f61e457181c2468f */
